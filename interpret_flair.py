...
def interpret_sentence(flair_model_wrapper, lig, sentence, target_label, visualization_list, n_steps=100, estimation_method="gausslegendre",internal_batch_size=None,attribute_to_layer_input=False):
    """
...
def visualize_attributions(visualization_list):
    ...
    return viz.visualize_text(visualization_list)
