...
class ModelWrapper(nn.Module):
    ...
    def __init__(self, flair_model, layers: str = "-1"):
        ...
        self.model = flair_model.embeddings.model
        ...
        self.model_name = flair_model.embeddings.get_names()[0].split('transformer-document-')[-1].replace('transformer-', '')
        ...
        self.embedding_length = self.flair_model.embeddings.embedding_length

        self.initial_cls_token = flair_model.embeddings.initial_cls_token
